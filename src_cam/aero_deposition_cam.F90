...
! TODO: make two files? One interface, one aerosol-internal?
!------------------------------------------------------------------------------
! Purpose:
!
...
! Private module data
  ...
  integer :: bcphi_ndx( pcnst ) = -1 ! TODO: get these indices out of here..
  integer :: bcphi_cnt = 0           ! phi: philic, pho: phobic
  ...
  real(r8), parameter :: bulk_dst_edges(n_bulk_dst_bins+1) = &
       (/0.1e-6_r8, 1.0e-6_r8, 2.5e-6_r8, 5.0e-6_r8, 10.e-6_r8/) ! TODO: move out of here! original CAM dust size dist? For now assume this is a host model thing
...
!TODO access hydrophilic/phobic from object
    ! black carbons
  ...
  subroutine aero_deposition_cam_setwet(aerdepwetis, aerdepwetcw, cam_out)
   ...
   do i = 1, ncol
!TODO: communicated to coupler, move cam_out out of this routine, create some intent(out) array here instead
! TODO: make one big array with consistent indices within the aerosol scheme -> list of aerosol objects to loop through
